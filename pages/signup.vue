...
import sectionContacts from '@/components/signup/Contatti.vue';
import sectionInfo from '@/components/signup/Info.vue';
import assocForm from '@/components/signup/Form.vue';
import sectionAssocList from '@/components/signup/AssocList.vue';
